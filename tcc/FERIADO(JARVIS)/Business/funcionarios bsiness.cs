...
namespace FERIADO_JARVIS_.Business
{
    class funcionarios_bsiness
    {
        ...
        public void deleta(   Mod.tb_funcionariosp tabela)
        {
            data.deleta(tabela);
        ...
        public List<Mod.tb_funcionariosp> consultarFuncionariosp()
        {
          
            List<Mod.tb_funcionariosp> tabela = data.consultarFuncionarios();
            return tabela;
        }
    }
}
